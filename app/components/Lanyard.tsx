...
export default function Lanyard({ 
  ...
  return (
    <div className="relative z-0 w-full h-[600px] flex justify-center items-center scale-100 origin-center cursor-grab active:cursor-grabbing">
      <Canvas
      ...
      >
        <Suspense fallback={null}>
          ...
          <Physics gravity={gravity} timeStep={isMobile ? 1 / 30 : 1 / 60}>
            <Band isMobile={isMobile} photoUrl={photoUrl} />
          </Physics>
          ...
          >
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial
                map={photoUrl ? customTexture : materials.base.map}
                map-anisotropy={16}
